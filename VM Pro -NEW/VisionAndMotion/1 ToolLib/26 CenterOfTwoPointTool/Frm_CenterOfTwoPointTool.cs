...
namespace VMPro
{
    internal partial class Frm_CenterOfTwoPointTool : Frm_FormBase
    {
        internal Frm_CenterOfTwoPointTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_CenterOfTwoPointTool _instance;
        public static Frm_CenterOfTwoPointTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_CenterOfTwoPointTool();
                return _instance;
            }
        }
        /// <summary>
