...
namespace VMPro
{
    internal partial class Frm_AngleLLTool : Frm_FormBase
    {
        internal Frm_AngleLLTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_AngleLLTool _instance;
        public static Frm_AngleLLTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_AngleLLTool();
                return _instance;
            }
        }
        /// <summary>
