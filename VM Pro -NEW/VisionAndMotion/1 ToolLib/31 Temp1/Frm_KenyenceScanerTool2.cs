...
namespace VMPro
{
    internal partial class Frm_KenyenceScanerTool2 : Frm_FormBase
    {
        internal Frm_KenyenceScanerTool2()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_KenyenceScanerTool2 _instance;
        public static Frm_KenyenceScanerTool2 Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_KenyenceScanerTool2();
                return _instance;
            }
        }
        /// <summary>
        /// 当前工具所对应的工具对象
        /// </summary>
        internal static KenyenceScanerTool2 kenyenceScanerTool2 = new KenyenceScanerTool2();
        ...
        private void btn_runKenyenceScannerTool_Click(object sender, EventArgs e)
        {
            ...
            kenyenceScanerTool2.Run(true, true, toolName);
            if (kenyenceScanerTool2.toolRunStatu != (Project.Instance.configuration.language == Language.English ? ToolRunStatu.Succeed : ToolRunStatu.成功))
                Frm_Main.Instance.OutputMsg(kenyenceScanerTool2.toolRunStatu.ToString(), Color.Red);
            else
                Frm_Main.Instance.OutputMsg(kenyenceScanerTool2.toolRunStatu.ToString(), Color.Black);
        ...
        {
            kenyenceScanerTool2.OpenPort();
        }

        private void btn_closePort_Click(object sender, EventArgs e)
        {
            kenyenceScanerTool2.ClosePort();
        }

        private void btn_send_Click(object sender, EventArgs e)
        {
            kenyenceScanerTool2.Send(tbx_sendMsg.Text.Trim());
        }

        private void cbx_portName_SelectedIndexChanged(object sender, EventArgs e)
        {
            kenyenceScanerTool2.portName = cbx_portName.Text.Trim();
        }
        ...
        private void cbx_baudRate_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                kenyenceScanerTool2.baudRate = Convert.ToInt32(cbx_baudRate.Text.Trim());
            }
            catch { }
        }
        ...
        private void tbx_dataBit_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                kenyenceScanerTool2.dataBit = Convert.ToInt16(cbx_dataBit.Text.Trim());
            }
            catch { }
        }
        ...
        {
            kenyenceScanerTool2.stopBit = (StopBits)Enum.Parse(typeof(StopBits), cbx_stopBit.Text);
        }
        private void cbx_parityBit_SelectedIndexChanged(object sender, EventArgs e)
        {
            kenyenceScanerTool2.parity = (Parity)Enum.Parse(typeof(Parity), cbx_parityBit.Text);
        }
        ...
        {
            kenyenceScanerTool2.Send("LON");
            kenyenceScanerTool2.Read();
        }
        private void btn_endScan_Click(object sender, EventArgs e)
        {
            kenyenceScanerTool2.Send("LOFF");
            kenyenceScanerTool2.Read();
        }
