...
namespace VMPro
{
    public partial class Frm_LightController : Form
    {
        public Frm_LightController()
        {
            InitializeComponent();
        ...
        /// 窗体实例对象
        /// </summary>
        private static Frm_LightController _instance;
        public static Frm_LightController Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_LightController();
                return _instance;
            }
        }
        ...
        public void LoadPar(LightController_Base lightController_1)
        {
            ...
            cbx_controllerName.TextStr = lightController.Name;
            cbx_IP.TextStr = lightController.IP;
        ...
        void cbx_IP_SelectedIndexChanged()
        {
            lightController.IP = cbx_IP.TextStr.Trim();
        }
        private void btn_openController_Click(object sender, EventArgs e)
        {
            ...
            {
                Frm_DeviceManager.Instance.lbl_tip.Text = "打开成功";
                Frm_DeviceManager.Instance.lbl_tip.ForeColor = Color.Green;
                btn_openController.Enabled = false;
            }
            else
            {
                Frm_DeviceManager.Instance.lbl_tip.Text = "打开失败";
                Frm_DeviceManager.Instance.lbl_tip.ForeColor = Color.Red;
            }
        }
