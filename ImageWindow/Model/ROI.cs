...
namespace ViewWindow.Model
{
	...
	public class ROI
	{
        ...
        protected bool wholeRegionMove = false;
        protected double wholeRegionMoveLastX = 0;
        protected double wholeRegionMoveLastY = 0;
        ...
        public virtual bool selectMoveHandleIfInside(double x, double y)
        {
            return false;
        }
        protected void startWholeRegionMove(double x, double y)
        {
            activeHandleIdx = -1;
            wholeRegionMove = true;
            wholeRegionMoveLastX = x;
            wholeRegionMoveLastY = y;
        }
        protected void getWholeRegionMoveDelta(double x, double y, out double deltaX, out double deltaY)
        {
            deltaX = x - wholeRegionMoveLastX;
            deltaY = y - wholeRegionMoveLastY;
            wholeRegionMoveLastX = x;
            wholeRegionMoveLastY = y;
        }
