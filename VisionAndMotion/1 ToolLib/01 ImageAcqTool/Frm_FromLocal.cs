...
namespace VMPro
{
    internal partial class Frm_FromLocal : Form
    {
        internal Frm_FromLocal()
        {
            InitializeComponent();
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_FromLocal _instance;
        public static Frm_FromLocal Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_FromLocal();
                return _instance;
            }
        }
        internal static Frm_FromLocal CurrentInstance
        {
